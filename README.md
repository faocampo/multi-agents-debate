...
* This code has been adapted from the original work by [100envy](https://x.com/h100envy): [A Swarm of Agents for Multi-Angle Analysis: Building a Team of Experts from LLMs](https://x.com/h100envy/status/2077371640690672001)
* Implementation repository at GitHub: [fedecampo/multi-agents-debate](https://github.com/fedecampo/multi-agents-debate)
